...
Java_cn_mucute_merminal_core_JNI_setPtyWindowSize(JNIEnv
*TERMUX_UNUSED(env),
jclass TERMUX_UNUSED(clazz),
        jint
fd,
...
extern "C" JNIEXPORT void JNICALL
Java_cn_mucute_merminal_core_JNI_setPtyUTF8Mode(JNIEnv
*TERMUX_UNUSED(env),
jclass TERMUX_UNUSED(clazz),
        jint
fd) {
...
Java_cn_mucute_merminal_core_JNI_waitFor(JNIEnv
*TERMUX_UNUSED(env),
jclass TERMUX_UNUSED(clazz),
        jint
pid) {
...
extern "C" JNIEXPORT void JNICALL
Java_cn_mucute_merminal_core_JNI_close(JNIEnv
*TERMUX_UNUSED(env),
jclass TERMUX_UNUSED(clazz),
        jint
fileDescriptor) {
